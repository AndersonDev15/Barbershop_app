    ...
    public OpenAPI barbershopAPI() {
        return new OpenAPI()
                ...
                .tags(List.of(
                        ...
                        new Tag()
                                .name("Barbería - Invitaciones")
                                .description("Creación, listado y cancelación de invitaciones a barberos"),
                        new Tag()
                        ...
                        // --- BARBERO ---
                        new Tag()
                                .name("Barbero - Invitaciones")
                                .description("Consulta, aceptación y rechazo de invitaciones recibidas"),
                        new Tag()
                                .name("Barbero - Disponibilidad y Descansos")
                                .description("Consulta de disponibilidad y gestión de descansos del barbero"),
                        new Tag()
                        ...
                        new Tag()
                                .name("Cliente - Perfil")
                                .description("Inicialización y consulta del perfil del cliente"),
                        new Tag()
