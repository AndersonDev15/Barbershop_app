  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-md p-4">
      <div className="w-full max-w-2xl bg-surface-container-lowest rounded-3xl overflow-hidden shadow-2xl flex flex-col max-h-[90vh]">
        ...
        {/* Footer */}
        <footer className="px-8 py-6 border-t border-outline-variant/10 bg-surface-container-low flex gap-4">
          {!reservationResult ? (
            <>
              {step > 1 && (
                <button
                  ...
                  className="flex-1 py-4 rounded-2xl border-2 border-outline-variant/10 font-black uppercase tracking-widest text-on-surface-variant hover:bg-surface-container-highest transition-all"
                >
                  Back
                </button>
              )}
              ...
              <button
                ...
                onClick={() =>
                  step === 4 ? handleConfirm() : setStep(step + 1)
                }
                className="flex-[2] py-4 rounded-2xl bg-primary text-on-primary font-black uppercase tracking-[0.2em] shadow-lg shadow-primary/20 hover:brightness-110 active:scale-[0.98] transition-all flex items-center justify-center gap-3 disabled:opacity-50"
              >
                {isConfirming ? (
            ...
            <button
              onClick={handleClose}
              className="w-full py-4 rounded-2xl bg-on-surface text-surface font-black uppercase tracking-[0.2em] shadow-lg hover:opacity-90 active:scale-[0.98] transition-all"
            >
              Close Wizard
            </button>
          )}
