  ...
  return (
    <section className="relative px-6 md:px-12 py-12 md:py-16 flex flex-col items-center text-center max-w-7xl mx-auto z-20">
      ...
      <div className="relative z-10 w-full max-w-4xl">
        ...
        <h1 className="font-headline text-4xl md:text-5xl lg:text-6xl font-extrabold text-on-surface tracking-tighter mb-4 leading-[1.1]">
          Encuentra la barbería perfecta <span className="text-primary italic">cerca de ti</span>
        </h1>
        <p className="font-body text-on-surface-variant/80 text-base md:text-lg max-w-2xl mx-auto mb-10">
