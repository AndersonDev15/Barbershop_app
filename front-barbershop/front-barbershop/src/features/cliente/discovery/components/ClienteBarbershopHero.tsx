    ...
    <div className="relative h-[200px] md:h-[280px] rounded-2xl overflow-hidden shadow-2xl group">
      ...
      <div className="absolute bottom-6 left-8 right-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div className="flex-1">
          <h1 className="text-3xl md:text-5xl font-headline font-black text-white tracking-tighter italic">
            {name}
          </h1>
        </div>

        {/* Action Quick Info - Mapeado con datos reales */}
        <div className="flex items-center gap-4 bg-white/5 backdrop-blur-xl p-4 rounded-xl border border-white/10 self-start md:self-auto">
          ...
          <div className="flex flex-col items-end">
            <span
              className={`text-[9px] font-black uppercase tracking-[0.2em] ${openNow ? "text-tertiary" : "text-on-surface-variant"}`}
            >
