  ...
  return (
    <div className="flex h-screen overflow-hidden bg-surface text-on-surface">
      ...
      <div className="flex flex-col flex-1 overflow-hidden w-full min-w-0">
        <ClienteTopBar />
        <main className="flex-1 overflow-y-auto bg-surface-dim p-4 md:p-8 lg:p-12 space-y-10">
          ...
          <footer className="pb-8 pt-6 border-t border-outline-variant/5 flex flex-col md:flex-row justify-between items-center gap-3">
            <p className="text-xs text-on-surface-variant">
              © 2024 {data.info.name}. All Rights Reserved.
            </p>
