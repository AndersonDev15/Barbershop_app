      ...
      <div className="flex items-center justify-end gap-3">
        {canPay && (
          <button
            ...
            className="px-5 py-2 rounded-full border border-primary/30 text-primary text-[10px] font-black uppercase tracking-widest hover:bg-primary/5 transition-all active:scale-95"
          >
            Pagar
          </button>
        )}
        {canCancel && (
          <button
            onClick={() => onCancel(id)}
            className="px-5 py-2 rounded-full border border-error/30 text-error text-[10px] font-black uppercase tracking-widest hover:bg-error/5 transition-all active:scale-95"
          >
            Cancelar
          </button>
        )}
        <button
          ...
          className="px-5 py-2 rounded-full bg-primary text-on-primary text-[10px] font-black uppercase tracking-widest shadow-lg shadow-primary/20 hover:brightness-110 transition-all active:scale-95 flex items-center gap-2"
        >
          Ver detalles
