          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
              <div>
                ...
                <h2 className="text-5xl font-extrabold tracking-tighter text-[#e5e2e1] font-['Manrope']">
                  Weekly Schedule
                </h2>
                <p className="text-[#99907c] font-medium mt-2 max-w-lg">
              ...
              <div className="flex flex-wrap gap-4">
                <button
                  ...
                  disabled={isSaving}
                  className="bg-[#d4af37] text-[#3c2f00] px-8 py-3 rounded-full font-bold text-sm flex items-center gap-2 hover:scale-[1.02] active:scale-95 transition-all shadow-xl disabled:opacity-70 disabled:pointer-events-none min-w-[140px] justify-center"
                >
                  {isSaving ? (
                    <>
            ...
            <div className="grid grid-cols-12 gap-8">
              ...
              <div className="col-span-12 lg:col-span-4 space-y-8">
                {/* Operational Days */}
                <section className="bg-[#1c1b1b] p-8 rounded-2xl border border-[#4d4635]/10 shadow-2xl">
                  <h3 className="font-['Manrope'] text-xl font-bold mb-6 flex items-center gap-3">
