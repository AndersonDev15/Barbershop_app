            ...
            <div className="flex flex-col mb-12">
              <div className="flex flex-col md:flex-row md:items-center justify-between w-full gap-6">
                <div>
                  ...
                  <h2 className="text-5xl font-extrabold text-[#e5e2e1] tracking-tighter font-['Manrope']">
                    Categories
                  </h2>
                </div>
                <button
                  onClick={() => setIsCreateCategoryOpen(true)}
                  className="px-8 py-3 rounded-full bg-[#f2ca50] text-[#3c2f00] font-bold flex items-center gap-2 hover:opacity-90 transition-all shadow-lg shadow-[#f2ca50]/10 self-start md:self-auto"
                >
