...
const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  const { user, setCoverImageUrl } = useAuthStore();
        ...
        <div className="space-y-12 pb-20">
          ...
          <div className="pt-8 flex items-center justify-end gap-6 border-t border-white/5">
            <button
              ...
              className="text-[#d0c5af] hover:text-[#e5e2e1] font-medium transition-colors"
            >
              Discard Changes
            </button>
            <button
              ...
              disabled={shopSaving}
              className="bg-[#f2ca50] text-[#3c2f00] px-10 py-4 rounded-full font-bold text-lg shadow-xl shadow-[#f2ca50]/10 hover:scale-105 active:scale-95 transition-all disabled:opacity-50 disabled:pointer-events-none flex items-center gap-2"
            >
              {shopSaving ? (
                <>
  ...
  const renderPrivacy = () => (
    <div className="px-12 py-10 space-y-12 max-w-5xl mx-auto w-full">
      <div className="space-y-2">
        <span className="text-xs font-bold uppercase tracking-[0.3em] text-[#f2ca50]/60">
          Credentials
        </span>
        <h3 className="text-4xl font-extrabold text-[#e5e2e1] font-['Manrope']">
          Privacy & Security
        </h3>
      </div>

      <div className="grid grid-cols-1 gap-8">
        <div className="bg-[#1c1b1b] p-8 rounded-2xl border border-white/5 space-y-6 shadow-xl">
          <div className="flex items-center gap-4">
            <div className="p-3 bg-[#2a2a2a] rounded-xl text-[#f2ca50]">
              <span className="material-symbols-outlined">storefront</span>
            </div>

            <div className="flex-1">
              <h4 className="text-lg font-bold text-[#e5e2e1]">Shop Status</h4>
          ...
          <div className="flex items-center justify-between pt-4">
            <div>
              ...
              <p className="text-xs text-[#d0c5af]/60">
                {shopStatus === "ACTIVO"
        ...
        <div className="bg-[#1c1b1b] p-8 rounded-2xl border border-white/5 space-y-8 shadow-xl">
          {pwSuccess && (
            <div className="bg-green-500/10 border border-green-500/20 text-green-400 px-6 py-3 rounded-xl text-sm font-bold flex items-center gap-2">
              <span className="material-symbols-outlined text-sm">
                check_circle
          ...
          <div className="pt-4 flex justify-end">
            <button
              ...
              disabled={pwLoading}
              className="bg-[#f2ca50] text-[#3c2f00] px-8 py-4 rounded-full font-bold text-sm flex items-center gap-2 hover:opacity-90 active:scale-95 transition-all shadow-lg shadow-[#f2ca50]/10 disabled:opacity-50 disabled:pointer-events-none"
            >
              {pwLoading ? (
                <>
                  <span className="material-symbols-outlined text-sm animate-spin">
