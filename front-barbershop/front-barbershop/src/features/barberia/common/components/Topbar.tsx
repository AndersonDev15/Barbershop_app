      ...
      <header className="bg-[#131313]/80 backdrop-blur-xl h-20 w-full z-40 flex items-center justify-between px-4 md:px-8 font-['Inter'] text-sm border-b border-white/5">
        ...
        <div className="flex items-center gap-4 md:gap-6">
          <div className="relative">
            <button className="md:hidden hover:bg-[#2a2a2a] rounded-full p-2 transition-colors text-[#e5e2e1]/60">
              <span className="material-symbols-outlined">search</span>
            </button>
            <div className="hidden md:block relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 material-symbols-outlined text-[#d0c5af]/50 text-lg">
                search
              </span>
              <input
                className="bg-[#2a2a2a] border-none rounded-full pl-10 pr-4 py-2 text-sm w-40 lg:w-64 focus:ring-1 focus:ring-[#f2ca50] transition-all outline-none text-[#e5e2e1] placeholder:text-[#d0c5af]/40"
