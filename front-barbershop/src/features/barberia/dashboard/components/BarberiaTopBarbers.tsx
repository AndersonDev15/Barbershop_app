...
export default function BarberiaTopBarbers({ data }: BarberiaTopBarbersProps) {
  ...
  return (
    <div className="bg-surface-container rounded-2xl p-4 md:p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        {data.map((barber, index) => {
          ...
          return (
            <div
              key={barber.barberId}
              className={`rounded-2xl p-4 md:p-6 flex items-center justify-between relative overflow-hidden transition-all ${
                isTop
            ...
            >
              ...
              <div className="flex items-center gap-2 md:gap-3">
                <div className="relative shrink-0">
                  <div
                    className={`w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center text-xs md:text-sm font-bold ${
                      isTop
                  ...
                  <div
                    className={`absolute -top-1 -left-1 w-5 h-5 rounded-full flex items-center justify-center text-[8px] md:text-[9px] font-black ${
                      isTop
                ...
                <div className="min-w-0">
                  <h4 className="font-headline font-bold text-xs md:text-sm text-on-surface truncate">
                    {barber.barberName}
                  </h4>
                  <p
              ...
              <div className="text-right shrink-0">
                <p className="font-headline font-extrabold text-base md:text-lg text-primary">
                  ${barber.income.toLocaleString()}
                </p>
                <p className="text-[8px] md:text-[9px] uppercase tracking-widest text-on-surface-variant font-bold">
                  Income
                </p>
              </div>
            </div>
