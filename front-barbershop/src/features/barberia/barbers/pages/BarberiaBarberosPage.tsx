        ...
        <main className="flex-1 overflow-y-auto bg-surface-dim p-4 md:p-8 max-w-[1600px] mx-auto w-full space-y-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-4 mb-8">
              ...
              <div className="flex items-center gap-2 bg-[#131313] border border-[#4d4635]/20 p-1.5 rounded-2xl overflow-x-auto no-scrollbar scroll-smooth">
                {(["all", "ACTIVO", "VACACIONES", "INACTIVO"] as const).map(
                  (filter) => (
                    <button
                      key={filter}
                      onClick={() => setActiveFilter(filter)}
                      className={`px-4 py-2 text-[10px] md:text-xs font-bold rounded-xl transition-all whitespace-nowrap ${
                        activeFilter === filter
              ...
              <button className="hidden lg:block p-4 bg-[#131313] border border-[#4d4635]/20 rounded-2xl text-[#99907c] hover:text-[#e5e2e1] transition-colors">
