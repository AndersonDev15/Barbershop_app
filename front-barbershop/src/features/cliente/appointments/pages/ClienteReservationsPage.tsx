      ...
      <div className="flex flex-col flex-1 overflow-hidden w-full min-w-0">
        ...
        <main className="flex-1 overflow-y-auto bg-surface-dim p-4 sm:p-6 md:p-8 lg:p-10 custom-scrollbar">
          <div className="mb-6 md:mb-8 px-2 md:px-0">
            ...
            <h1 className="text-3xl md:text-4xl font-headline font-black tracking-tight text-on-surface italic uppercase">
              Gestionar Citas
            </h1>
          </div>

          {/* Tabs de Filtro */}
          <div className="flex items-center gap-2 mb-6 md:mb-8 overflow-x-auto pb-4 no-scrollbar -mx-4 px-4 md:mx-0 md:px-0">
