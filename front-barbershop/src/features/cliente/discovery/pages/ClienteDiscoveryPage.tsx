  ...
  return (
    <div className="flex h-screen overflow-hidden bg-surface text-on-surface">
      ...
      <div className="flex flex-col flex-1 overflow-hidden w-full min-w-0">
        ...
        <main className="flex-1 overflow-y-auto bg-surface-dim custom-scrollbar">
          <div className="pt-4 md:pt-8">
            <ClienteDiscoveryHero />
            <ClienteFeaturedShops />
          </div>

          <footer className="w-full border-t border-outline-variant/10 bg-[#0e0e0e] mt-12 md:mt-24">
            <div className="flex flex-col md:flex-row justify-between items-center px-6 md:px-12 py-8 w-full gap-6 md:gap-4 text-center md:text-left">
