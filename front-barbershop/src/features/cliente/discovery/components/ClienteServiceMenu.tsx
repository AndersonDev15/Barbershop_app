      ...
      <div>
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 md:mb-8 gap-4">
          ...
          {onBookNow && (
            <button
              onClick={onBookNow}
              className="w-full sm:w-auto bg-primary text-on-primary px-8 py-3.5 rounded-full font-black text-[10px] uppercase tracking-widest shadow-[0_8px_24px_rgba(242,202,80,0.3)] hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-2"
            >
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full flex justify-between items-center p-5 md:p-6 hover:bg-surface-container-high transition-colors text-left"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <span className="font-black text-on-surface uppercase tracking-tight text-sm md:text-base">
                      {category.name}
                    </span>
                  </div>
                  {isLoading ? (
